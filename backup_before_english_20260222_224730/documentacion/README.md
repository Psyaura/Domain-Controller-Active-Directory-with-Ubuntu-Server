...
|---------|-------------|--------|
| [01-instalacion-base.md](01-instalacion-base.md) | Instalación de Ubuntu Server y configuración de VM | ⬜ |
| [02-configuracion-red.md](02-configuracion-red.md) | Configuración de red estática, hostname y DNS | ⬜ |
...
| Archivo | Descripción | Estado |
|---------|-------------|--------|
| [04-gestion-usuarios.md](04-gestion-usuarios.md) | Creación y gestión de usuarios, grupos y OUs | ⬜ |

### 🖥️ Fase 3: Integración de Clientes

| Archivo | Descripción | Estado |
|---------|-------------|--------|
| [05-union-clientes.md](05-union-clientes.md) | Unión de clientes Linux y Windows al dominio | ⬜ |
...
| [07-recursos-compartidos.md](07-recursos-compartidos.md) | File Server, recursos compartidos y permisos | ⬜ |

### 🤝 Fase 5: Confianzas y Dominios

| Archivo | Descripción | Estado |
|---------|-------------|--------|
| [08-trusts.md](08-trusts.md) | Configuración de confianzas entre dominios (Forest Trust) | ⬜ |

### 📊 Fase 6: Seguridad y Administración

| Archivo | Descripción | Estado |
|---------|-------------|--------|
| [09-auditoria.md](09-auditoria.md) | Auditoría, logs y políticas de seguridad | ⬜ |
| [10-automatizacion.md](10-automatizacion.md) | Scripts de backup, cron y monitorización | ⬜ |
...
- **Evidencias**: [../evidencias/](../evidencias/) - Capturas de pantalla organizadas
