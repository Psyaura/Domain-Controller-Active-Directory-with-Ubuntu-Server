...
├── evidence/                        # Screenshots and tests
...
![VirtualBox network configuration](/evidence/01-installation/Instalacion%20Linux%20Vbox.png)

> **📸 See more evidence**: [/evidence/01-installation/](/evidence/01-installation/)
...
![VirtualBox network configuration](/evidence/02-configuration/netplan_serv.png)
...
![Make sure of DNS](/evidence/02-configuration/hosts_serv.png)
...
![Kerberos configuration](/evidence/02-configuration/krb.png)
...
![DC verification](/evidence/02-configuration/kinit.png)
...
![Users and OUs management](/evidence/03-users-groups/mover_usu_OU.png)
...
![Configured file](/evidence/02-configuration/resolv_cli.png)
...
![Configured file](/evidence/02-configuration/hosts_cli.png)
...
![Ubuntu client joining](/evidence/04-clients/realm_join.png)
...
![Graphical login with domain user](/evidence/04-clients/ubuntu-graphical-login.png)
...
![Error Domain Users Group](/evidence/06-resources/error_domain_users_group.png)
...
![Permission management in Windows](/evidence/06-resources/windows-acl-management.png)
...
![Automatic mounting on Linux](/evidence/06-resources/linux-auto-mount.png)
...
![Cross-domain access](/evidence/07-trusts/cross-domain-access.png)
...
![Audit logs](/evidence/08-auditing/audit-logs.png)
...
![Backup script](/evidence/08-auditing/backup-script.png)
...
![Monitoring with htop](/evidence/08-auditing/htop-monitoring.png)
